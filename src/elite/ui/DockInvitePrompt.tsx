...
/**
 * Mid-windscreen ship-AI relay when a station offers docking clearance.
 * Conversational framing — station → ship mind → player (Banks-style relay).
 */
    ...
    >
      ...
      >
        ...
        <div style={{
          ...
          {stationName} is inviting you to dock
        </div>
        <div style={{
          marginTop: 10,
          fontSize: 11,
